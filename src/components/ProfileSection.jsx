  ...
  return (
    <section className="relative w-full bg-[#95C3D4] flex flex-col lg:flex-row items-stretch min-h-[600px] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center relative px-2">
        ...
        {/* ======== MOBILE VERSION ======== */}
        <div className="flex flex-col items-center text-center py-3 lg:hidden">
          {/* Nama */}
          <h1
            className="text-[70px] sm:text-[100px] font-extrabold text-white leading-none"
          ...
          {/* Tagline */}
          <div className="flex flex-col text-[#cbf0f4] font-extrabold uppercase leading-none mb-4">
            <span
              className="text-[28px] sm:text-[32px] leading-none tracking-wider"
              style={{ fontFamily: "var(--font-impact)" }}
            >
              AUTHOR, SPEAKER,  LEADER
            </span>
            <span
              className="text-[28px] sm:text-[32px] leading-none"
              style={{ fontFamily: "var(--font-impact)" }}
            >
              
            </span>
            <span
              className="text-[28px] sm:text-[32px] leading-none tracking-[4px]"
              style={{ fontFamily: "var(--font-impact)" }}
            >
          ...
          <div className="flex justify-center items-center">
            <div className="overflow-hidden rounded-[20px] shadow-lg">
              <Image
                ...
                width={450}
                height={300}
                className="object-cover w-[320px] h-[180px] sm:w-[450px] sm:h-[250px]"
              />
            </div>
          </div>
        </div>

        {/* ======== DESKTOP VERSION (ASLI, JANGAN DIUBAH) ======== */}
        ...
        <div className="hidden lg:flex flex-row items-start w-full">
          {/* === Kiri: LIU + Tagline === */}
          <div className="flex flex-col mr-6">
            ...
            <div className="flex flex-col text-[#cbf0f4] font-extrabold uppercase leading-none">
              <span
                className="text-[32px] sm:text-[36px] lg:text-[60px] leading-none tracking-wider"
                style={{ fontFamily: "var(--font-impact)" }}
              >
                AUTHOR
              </span>
              <span
                className="text-[32px] sm:text-[36px] lg:text-[60px] leading-none"
                style={{ fontFamily: "var(--font-impact)" }}
              >
                SPEAKER
              </span>
              <span
                className="text-[32px] sm:text-[36px] lg:text-[60px] leading-none tracking-[4px] lg:tracking-[8px]"
                style={{ fontFamily: "var(--font-impact)" }}
              >
                LEADER
              </span>
