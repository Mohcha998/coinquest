...
export default function TokohSection() {
  ...
  return (
    ...
    >
      ...
      {/* Judul */}
      <h2 className="relative text-[#FFADBF] z-20 text-2xl sm:text-3xl md:text-5xl font-bold -mt-[30px] flex flex-col"
        style={{ fontFamily: "var(--font-moresugar)" }}
      >
        CERITA & PENGALAMAN NYATA
      </h2>
      <h3 className="relative text-[#5DD5E4] z-20 text-2xl sm:text-3xl md:text-5xl font-bold mt-1"
        style={{ fontFamily: "var(--font-moresugar)" }}
      >
